...
var Apa102InterlacedClock = (function (_super) {
    __extends(Apa102InterlacedClock, _super);
    function Apa102InterlacedClock(PRU_NUM, overallChannelCount) {
        _super.call(this, PRU_NUM, overallChannelCount = Math.min(24, overallChannelCount));
        ...
        bbbPinData_1.pinIndex.applyInterlacedClockPinMapping(this.pruPinCount);
        this.clockPins = bbbPinData_1.pinIndex.pinsByPruAndPin[PRU_NUM]
            .filter(function (pin) { return pin.clockChannelIndex >= 0; });
        this.dataPins = bbbPinData_1.pinIndex.pinsByPruAndPin[PRU_NUM]
            .filter(function (pin) { return pin.dataChannelIndex >= 0; });
        console.error("Using " + this.pruChannelCount + " channels on PRU" + PRU_NUM);
    }
    Apa102InterlacedClock.prototype.DATAS_HIGH = function (pins) {
        this.PINS_HIGH(pins || this.dataPins, (pins ? "" : "All ") + "Data");
    };
    Apa102InterlacedClock.prototype.DATAS_LOW = function (pins) {
        this.PINS_LOW(pins || this.dataPins, (pins ? "" : "All ") + "Data");
    };
    Apa102InterlacedClock.prototype.CLOCKS_HIGH = function (pins) {
        this.PINS_HIGH(pins || this.clockPins, (pins ? "" : "All ") + "Clock");
    };
    Apa102InterlacedClock.prototype.CLOCKS_LOW = function (pins) {
        this.PINS_LOW(pins || this.clockPins, (pins ? "" : "All ") + "Clock");
    };
    Apa102InterlacedClock.prototype.CLOCKS_PULSE = function (pins) {
        this.PINS_HIGH_LOW(pins || this.clockPins, (pins ? "" : "All ") + "Clock");
    };
    Apa102InterlacedClock.prototype.fileHeader = function () {
        this.emitComment("//////////////////////////////////////////////////////////////////////////////////////////////");
    ...
    Apa102InterlacedClock.prototype.frameCode = function () {
        var g = this;
        ...
        g.pruBlock(function () {
            ...
            g.pruBlock(function () {
                ...
                g.CLOCKS_HIGH();
                g.groupByBank(g.dataPins, function (pins, gpioBank) {
    ...
    return Apa102InterlacedClock;
})(common_1.BaseSetupPruProgram);
Object.defineProperty(exports, "__esModule", { value: true });
exports.default = Apa102InterlacedClock;
//# sourceMappingURL=apa102.js.map